...
export default function Project({
  ...
  return (
    ...
    >
      <section ref={ref} className="group bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[23rem] sm:group-even:pl-8 transition hover:bg-gray-200 rounded-lg dark:bg-white/10 dark:hover:bg-white/20">
